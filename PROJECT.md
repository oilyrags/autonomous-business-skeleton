...
| Agent registry scope | All 12 C-suite + highest-leverage domain agents (representative, not exhaustive) | 2026-06-30 | Open follow-up: expand to full roster across all 16 contexts (see Pending). |
...
| 05 | `05_agent_registry.json` | ✅ Done (representative) | Valid JSON; roster not exhaustive |
...
- [ ] **Expand `05_agent_registry.json`** to the full agent roster across all 16 bounded contexts (currently representative). — *raised 2026-06-30, awaiting user go-ahead*
- [ ] Optionally deepen any artifact on request (no specific request yet).
